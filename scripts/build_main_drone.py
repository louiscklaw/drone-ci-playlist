...
def writeMainDroneYml(filepath, content_in):
  main_drone_yml_template ="# don't modify this file, this file is generated by scripts/build_main_drone.py"+'\n\n'


  file_content = main_drone_yml_template+content_in
  f_main_drone = open(filepath,'w+')
  f_main_drone.truncate(0)
  f_main_drone.writelines(file_content)
  f_main_drone.close()
